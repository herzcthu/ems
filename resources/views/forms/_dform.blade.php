...
<div class="form-group col-md-12">
    ...
    {!! Form::select('enu_id', isset($enumerators) ? $enumerators:['none' => 'None'], ['class' => 'col-md-2 form-control']) !!}
</div>

<div class="form-group col-md-12">
    {!! Form::label('interviewee_id', 'Survey Form ID: ', ['class' => 'control-label pull-left']) !!}
    <div class="col-md-4">
